...
const Checkout = (props) => {
    const [formInputsValidity,setFormInputsalidity]= useState({
        name:true,
        street:true,
        city:true,
        postalCode:true
  ...
  return (
    <form className={classes.form} onSubmit={confirmHandler}>
      ...
      <div className={`${classes.control} ${formInputsValidity.city ?'':classes.invalid}`}>
        ...
        {!formInputsValidity.postalCode&&<p>Please enter valid postal code (5 character).</p>}
      </div>
